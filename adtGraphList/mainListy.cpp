...
{
    Lista list1;
    list1.Insert(1, nullptr, 0);
    list1.Insert(10, nullptr, 0);                  // przy nastepnym wstawianiu po nullptr sie wysypuje
    list1.Insert(2, list1.Locate(1), 0);                          
    list1.Insert(3, list1.Locate(2), 0);
    list1.Insert(4, list1.Locate(3), 0);
    list1.Insert(5, list1.Locate(4), 0);
